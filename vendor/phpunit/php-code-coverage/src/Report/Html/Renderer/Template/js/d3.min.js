!(function () {
	...
	function t(n) {
		return n && (n.ownerDocument?.defaultView || (n.document && n) || n.defaultView);
	}
	function e(n, t) {
	...
	function v() {
		var n = 0;
		for (var _t in this._) ++n;
		return n;
	}
	function d() {
		for (var _n in this._) return !1;
		return !0;
	}
	function y() {
		this._ = Object.create(null);
	...
	function I(n) {
		return arguments.length || (n = e), (t, e) => (t && e ? n(t.__data__, e.__data__) : !t - !e);
	}
	function Y(n, t) {
	...
	function sn(n, t, e) {
		return Number.isNaN(n) && (n = 0), Number.isNaN(t) && (t = 0), new hn(e, Math.cos((n *= Yo)) * t, Math.sin(n) * t);
	}
	function hn(n, t, e) {
	...
	function yn(n) {
		return Math.round(255 * (0.00304 >= n ? 12.92 * n : 1.055 * n ** (1 / 2.4) - 0.055));
	}
	function mn(n, t, e) {
	...
	function _n(n, t, e) {
		...
		return (u = ua.get(n))
			...
			: (null == n ||
					"#" !== n.charAt(0) ||
					Number.isNaN((u = parseInt(n.slice(1), 16))) ||
					(4 === n.length
						? ((o = (3840 & u) >> 4),
							(o = (o >> 4) | o),
							(a = 240 & u),
	...
	function Tn() {
		var n = Rn(),
			t = Dn() - n;
		t > 24 ? (Number.isFinite(t) && (clearTimeout(ca), (ca = setTimeout(Tn, t))), (la = 0)) : ((la = 1), fa(Tn));
	}
	function Rn() {
	...
	function ht(n, t) {
		n && Object.hasOwn(wa, n.type) && wa[n.type](n, t);
	}
	function pt(n, t, e) {
		var r,
			i = -1,
	...
	function Ct(n, t) {
		...
		return n.invert && t.invert && (e.invert = (e, r) => ((e = t.invert(e, r)), e && n.invert(e[0], e[1]))), e;
	}
	function zt() {
		return !0;
	}
	...
	function Zt(n, t, e, r) {
		...
		return (a) => {
			...
			function h() {
				(C.point = g), d?.push((y = [])), (S = !0), (w = !1), (b = _ = NaN);
			}
			function p() {
	...
	function ae(n) {
		...
		var u,
			...
			S = null;
		return (
			(t.stream = (n) => (f && (f.valid = !1), (f = le(b(o, s(_(n))))), (f.valid = !0), f)),
	...
	function he(n) {
		return (t, e) => ((t += n), [t > Fo ? t - Ho : -Fo > t ? t + Ho : t, e]);
	}
	function pe(n) {
		var t = he(n);
	...
	function Se(n, t) {
		...
		return u
			? ((e.invert = (n, t) => {
					...
					return [Math.atan2(n, e) / u, 2 * Math.atan((o / r) ** (1 / u)) - Io];
				}),
				e)
			: Ne;
	}
	...
	function vr(n, t) {
		...
		var e = n.r,
			...
			o = t.g - r,
			a = t.b - i;
		return (n) => `#${bn(Math.round(e + u * n))}${bn(Math.round(r + o * n))}${bn(Math.round(i + a * n))}`;
	}
	function dr(n, t) {
		var e,
			r = {},
	...
	function Lr(n, t) {
		...
		return (
			...
			(r) => 1 + n * 2 ** (-10 * r) * Math.sin(((r - e) * Ho) / t)
		);
	}
	function qr(n) {
	...
	function Rr(n, t) {
		...
		return (
			...
			Number.isNaN(u) ? ((u = 0), (e = Number.isNaN(e) ? t.h : e)) : u > 180 ? (u -= 360) : -180 > u && (u += 360),
	...
	function fi(n) {
		return ao.merge(n.map((n) => (n.children || []).map((t) => ({ source: n, target: t }))));
	}
	function si(n) {
		return n.x;
	}
	...
	function $i(n) {
		return n ? { floor: (t) => Math.floor(t / n) * n, ceil: (t) => Math.ceil(t / n) * n } : Sl;
	}
	function Bi(n, t, e, r) {
		var i = [],
			u = [],
	...
	function Wi(n, t, e, r) {
		...
		return (
			...
			(u.rangeRound = (n) => u.range(n).interpolate(Ur)),
			(u.clamp = function (n) {
	...
	function Ki(n, t) {
		...
		var e = Yi(n),
			r = e[1] - e[0],
			i = 10 ** Math.floor(Math.log(r / t) / Math.LN10),
			u = (t / r) * i;
		return (
	...
	function iu(n, t, e) {
		...
		return (
			...
			(r.ticks = (n) => Qi(e, n)),
			(r.tickFormat = (n, t) => nu(e, n, t)),
			(r.nice = (n) => r.domain(Gi(e, n))),
			(r.exponent = function (o) {
				return arguments.length ? ((i = uu((t = o))), (u = uu(1 / t)), n.domain(e.map(i)), r) : t;
			}),
			(r.copy = () => iu(n.copy(), t, e)),
			Ji(r, n)
		);
	}
	function uu(n) {
	...
	function ou(n, t) {
		...
		function r(t, e) {
			return ao.range(n.length).map((n) => t + e * n);
		}
		var i, u, o;
		return (
			(e.domain = function (r) {
	...
	function au(n, t) {
		...
		function o(n) {
			return Number.isNaN((n = +n)) ? void 0 : t[ao.bisect(a, n)];
		}
		var a;
		return (
			(o.domain = function (t) {
	...
	function lu(n, t, e) {
		...
		return (
			...
			(r.invertExtent = (t) => ((t = e.indexOf(t)), (t = 0 > t ? NaN : t / u + n), [t, t + 1 / u])),
			(r.copy = () => lu(n, t, e)),
			i()
		);
	}
	...
	function Qu(n, t, e, r, i) {
		...
		function _o(e) {
			...
			u &&
				...
				--g.count,
				delete g[i],
				u.event?.interrupt.call(n, n.__data__, u.index));
			for (var o in g)
				if (r > +o) {
					var c = g[o];
			...
			(f.c = a),
				qn(() => (f.c && a(e || 1) && ((f.c = null), (f.t = NaN)), 1), 0, l),
				(g.active = r),
				v.event?.start.call(n, n.__data__, t),
				(p = []),
				v.tween.forEach((_e, r) => {
		...
		function _a(i) {
			...
			return u >= 1 ? (v.event?.end.call(n, n.__data__, t), --g.count ? delete g[r] : delete n[e], 1) : void 0;
		}
		var l,
			f,
			_s,
	...
	function no(n, t, e) {
		n.attr("transform", (n) => {
			var r = t(n);
			return `translate(${Number.isFinite(r) ? r : e(n)},0)`;
		});
	}
	function to(n, t, e) {
		n.attr("transform", (n) => {
			var r = t(n);
			return `translate(0,${Number.isFinite(r) ? r : e(n)})`;
		});
	}
	function eo(n) {
	...
	if ((Date.now || (Date.now = () => Date.now()), fo))
		try {
	...
	(ao.ascending = e),
		(ao.descending = (n, t) => (n > t ? -1 : t > n ? 1 : t >= n ? 0 : NaN)),
		(ao.min = function (n, t) {
			var e,
				r,
				i = -1,
	...
	(ao.bisectLeft = Mo.left),
		...
		(ao.bisector = (n) => u(1 === n.length ? (t, r) => e(n(t), r) : n)),
	...
	(ao.dispatch = function () {
		...
		(_.prototype.on = function (n, t) {
			...
			if (2 === arguments.length) {
				if (null == t) for (n in this) Object.hasOwn(this, n) && this[n].on(r, null);
				return this;
			}
		}),
		(ao.event = null),
		(ao.requote = (n) => n.replace(So, "\\$&"));
	var So = /[\\^$*+?|[\]().{}]/g,
		ko = {}.__proto__
			? (n, t) => {
					n.__proto__ = t;
		...
		No = (n, t) => t.querySelector(n),
		Eo = (n, t) => t.querySelectorAll(n),
		Ao = (n, t) => {
			var e = n.matches || n[x(n, "matchesSelector")];
			return (Ao = (n, t) => e.call(n, t))(n, t);
		};
	"function" === typeof Sizzle &&
		((No = (n, t) => Sizzle(n, t)[0] || null), (Eo = Sizzle), (Ao = Sizzle.matchesSelector)),
		(ao.selection = () => ao.select(fo.documentElement));
	...
	(ao.ns = {
		...
		qualify: (n) => {
			...
			return (
				...
				Object.hasOwn(Lo, e) ? { space: Lo[e], local: n } : n
			);
		},
	}),
			...
			function e(n, t, e, u, o) {
				return function () {
					...
					var c,
						...
						_m = W(s),
						M = t(h, v);
					i ? ((c = i.apply(this, arguments)), (c = [c.x - M[0], c.y - M[1]])) : (c = [0, 0]), p({ type: "dragstart" });
				};
			}
			var r = N(n, "drag", "dragstart", "dragend"),
				i = null,
				_u = e(b, ao.mouse, t, "mousemove", "mouseup"),
				_o = e(G, ao.touch, m, "touchmove", "touchend");
			return (
				(n.origin = function (t) {
	...
	(ao.interpolateZoom = (n, t) => {
		var e,
			...
			s = l - u,
			h = f * f + s * s;
		if (jo > h) (r = Math.log(c / o) / Vo), (e = (n) => [i + n * f, u + n * s, o * Math.exp(Vo * n * r)]);
		else {
			var p = Math.sqrt(h),
		...
		(ao.behavior.zoom = () => {
			...
			function s() {
				...
				var o = D.of(this, arguments),
					_a = 0,
					_s = ao.select(t(this)).on(q, n).on(T, r),
					_h = e(ao.mouse(this)),
					_p = W(this);
				Il.call(this), l(o);
			}
			function _h() {
				...
				function _a() {
					if (ao.event.touches.length) {
						...
						for (var _i in d) return void n();
					}
					ao.selectAll(_).on(m, null), w.on(L, s).on(R, _h), N(), f(v);
				}
				var _p,
					v = D.of(this, arguments),
					_d = {},
					_y = 0,
			...
			return (
				Wo ||
					(Wo =
						"onwheel" in fo
							? ((Bo = () => -ao.event.deltaY * (ao.event.deltaMode ? 120 : 1)), "wheel")
							: "onmousewheel" in fo
								? ((Bo = () => ao.event.wheelDelta), "mousewheel")
								: ((Bo = () => -ao.event.detail), "MozMousePixelScroll")),
				(n.event = (n) => {
					n.each(function () {
						var n = D.of(this, arguments),
							t = k;
				...
				(n.x = function (t) {
					return arguments.length ? ((b = t), (_x = t.copy()), (k = { x: 0, y: 0, k: 1 }), n) : b;
				}),
				(n.y = function (t) {
	...
	(Go.brighter = function (n) {
		return (n = 0.7 ** (arguments.length ? n : 1)), new ln(this.h, this.s, this.l / n);
	}),
		(Go.darker = function (n) {
			return (n = 0.7 ** (arguments.length ? n : 1)), new ln(this.h, this.s, n * this.l);
		}),
		(Go.rgb = function () {
	...
	(ia.brighter = function (n) {
		...
		(ia.darker = function (n) {
			return (n = 0.7 ** (arguments.length ? n : 1)), new mn(n * this.r, n * this.g, n * this.b);
		}),
		(ia.hsl = function () {
			...
			return (
				(e.parse = (n, t) => {
					...
					return e.parseRows(n, (n, e) => {
						if (r) return r(n, e - 1);
						var i = new Function("d", `return {${n.map((n, t) => `${JSON.stringify(n)}: d[${t}]`).join(",")}}`);
						r = t ? (n, e) => t(i(n), e) : i;
					});
				}),
				(e.parseRows = (n, t) => {
					...
					for (var r, _i, u = {}, o = {}, a = [], _c = n.length, _f = 0, s = 0; (r = e()) !== o; ) {
				...
				(e.format = (t) => {
					...
					return (
						...
						[i.map(o).join(n)].concat(t.map((t) => i.map((n) => o(t[n])).join(n))).join("\n")
					);
				}),
	...
	(ao.timer = function () {
		...
		(ao.round = (n, t) => (t ? Math.round(n * (t = 10 ** t)) / t : Math.round(n)));
	...
	var ha = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
		pa = ao.map({
			...
			f: (n, t) => n.toFixed(t),
			r: (n, t) => (n = ao.round(n, Pn(n, t))).toFixed(Math.max(0, Math.min(20, Pn(n * (1 + 1e-15), t)))),
		}),
		ga = (ao.time = {}),
		va = Date;
	Hn.prototype = {
	...
	(ga.year = On(
		...
		["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"].forEach((n, t) => {
			t = 7 - t;
			var e = (ga[n] = On(
				(n) => ((n = ga.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n),
				(n, t) => {
	...
	var ya = { "-": "", _: " ", 0: "0" },
		ma = /^\s*\d+/,
		Ma = /^%/;
	ao.locale = (n) => ({ numberFormat: jn(n), timeFormat: Yn(n) });
	var xa = ao.locale({
		decimal: ".",
		thousands: ",",
		grouping: [3],
	...
	var ba = new ft();
	ao.geo.stream = (n, t) => {
		n && Object.hasOwn(_a, n.type) ? _a[n.type](n, t) : ht(n, t);
	};
	var _a = {
			Feature: (n, t) => {
				ht(n.geometry, t);
	...
	ao.geo.area = (n) => ((Sa = 0), ao.geo.stream(n, Na), Sa);
	var Sa,
		ka = new ft(),
		Na = {
			sphere: () => {
	...
	(ao.geo.clipExtent = () => {
		...
		((ao.geo.conicEqualArea = () => Vt(Xt)).raw = Xt),
		(ao.geo.albers = () =>
			ao.geo.conicEqualArea().rotate([96, 0]).center([-0.6, 38.7]).parallels([29.5, 45.5]).scale(1070)),
		(ao.geo.albersUsa = () => {
			function n(n) {
				var u = n[0],
					o = n[1];
	...
	(ao.geo.path = () => {
		...
		var e,
			...
			a = 4.5;
		return (
			(n.area = (n) => ((Oa = 0), ao.geo.stream(n, i($a)), Oa)),
			(n.centroid = (n) => (
		...
		((ao.geo.equirectangular = () => oe(ce)).raw = ce.invert = ce),
		(ao.geo.rotation = (n) => {
			function t(t) {
			...
			return (
				...
				(t.invert = (t) => ((t = n.invert(t[0] * Yo, t[1] * Yo)), (t[0] *= Zo), (t[1] *= Zo), t)),
				t
			);
		}),
		(fe.invert = ce),
		...
		(ao.geo.graticule = () => {
			...
			return (
				...
				(n.precision = function (t) {
					return arguments.length
						? ((m = +t), (_f = ye(a, o, 90)), (_s = me(r, e, m)), (h = ye(c, l, 90)), (p = me(u, i, m)), n)
						: m;
				}),
				n
					.majorExtent([
		...
		(ao.geo.interpolate = (n, t) => be(n[0] * Yo, n[1] * Yo, t[0] * Yo, t[1] * Yo)),
		(ao.geo.length = (n) => ((Ja = 0), ao.geo.stream(n, Ga), Ja));
	var Ja,
	...
	(ao.geo.azimuthalEqualArea = () => oe(Ka)).raw = Ka;
	var Qa = we((n) => {
		var t = Math.acos(n);
		return t && t / Math.sin(t);
	}, m);
	((ao.geo.azimuthalEquidistant = () => oe(Qa)).raw = Qa),
		((ao.geo.conicConformal = () => Vt(Se)).raw = Se),
		((ao.geo.conicEquidistant = () => Vt(ke)).raw = ke);
	var nl = we((n) => 1 / n, Math.atan);
	((ao.geo.gnomonic = () => oe(nl)).raw = nl),
		(Ne.invert = (n, t) => [n, 2 * Math.atan(Math.exp(t)) - Io]),
		((ao.geo.mercator = () => Ee(Ne)).raw = Ne);
	var tl = we(() => 1, Math.asin);
	(ao.geo.orthographic = () => oe(tl)).raw = tl;
	var el = we(
		(n) => 1 / (1 + n),
		(n) => 2 * Math.atan(n),
	);
	((ao.geo.stereographic = () => oe(el)).raw = el),
		(Ae.invert = (n, t) => [-t, 2 * Math.atan(Math.exp(n)) - Io]),
		((ao.geo.transverseMercator = () => {
			...
			return (
				...
				(n.rotate = (n) => (n ? e([n[0], n[1], n.length > 2 ? n[2] + 90 : 90]) : ((n = e()), [n[0], n[1], n[2] - 90]))),
				e([0, 0, 90])
			);
		}).raw = Ae),
		(ao.geom = {}),
	...
	(Ye.prototype.prepare = function () {
		...
		(er.prototype = {
			...
			remove: function (n) {
				...
				if (
					...
					if (n?.C) return void (n.C = !1);
					do {
						if (n === this._) break;
						if (n === i.L) {
							if (((t = i.R), t.C && ((t.C = !1), (i.C = !0), ir(this, i), (t = i.R)), t.L?.C || t.R?.C)) {
								t.R?.C || ((t.L.C = !1), (t.C = !0), ur(this, t), (t = i.R)),
									(t.C = i.C),
									(i.C = t.R.C = !1),
									ir(this, i),
									(n = this._);
						...
						} else if (((t = i.L), t.C && ((t.C = !1), (i.C = !0), ur(this, i), (t = i.L)), t.L?.C || t.R?.C)) {
							t.L?.C || ((t.R.C = !1), (t.C = !0), ir(this, t), (t = i.L)),
								(t.C = i.C),
								(i.C = t.L.C = !1),
								ur(this, i),
								(n = this._);
		...
		(ao.geom.voronoi = (n) => {
			...
			function e(n) {
				return n.map((n, t) => ({ x: Math.round(u(n, t) / Uo) * Uo, y: Math.round(o(n, t) / Uo) * Uo, i: t }));
			}
			var r = Ce,
				i = ze,
				u = r,
			...
			return n
				...
				: ((t.links = (n) =>
					...
					(t.size = function (n) {
						return arguments.length ? t.clipExtent(n && [[0, 0], n]) : a === sl ? null : a?.[1];
					}),
					t);
		});
	var sl = [
	...
	(ao.geom.delaunay = (n) => ao.geom.voronoi().triangles(n)),
	...
	var gl = () => m,
		...
		dl = ao.map({ in: m, out: _r, "in-out": wr, "out-in": (n) => wr(_r(n)) });
	(ao.ease = function (n) {
		var t = n.indexOf("-"),
			e = t >= 0 ? n.slice(0, t) : n,
	...
	(ao.interpolateTransform = $r),
		...
		(ao.layout.chord = () => {
			...
			function t() {
				e.sort((n, t) => l((n.source.value + n.target.value) / 2, (t.source.value + t.target.value) / 2));
			}
			var e,
				r,
				i,
			...
			return (
				...
				(l.start = function () {
					function n(n, r) {
						...
						for (var o, a = e[t], l = -1, f = a.length; ++l < f; ) if (!Number.isNaN((o = a[l][n]))) return o;
		...
		(ao.layout.pie = () => {
			function n(o) {
				var a,
					...
					y = [];
				return (
					null != e && d.sort(e === bl ? (n, t) => c[t] - c[n] : (n, t) => e(o[n], o[t])),
					d.forEach((n) => {
	...
	var _l = ao.map({
			...
			reverse: (n) => ao.range(n.length).reverse(),
			default: gi,
		}),
		wl = ao.map({
			silhouette: (n) => {
	...
	(ao.layout.histogram = () => {
		...
		return (
			...
			(n.bins = function (t) {
				return arguments.length ? ((i = "number" === typeof t ? (n) => xi(n, t) : En(t)), n) : i;
			}),
		...
		(ao.layout.cluster = () => {
			function n(n, u) {
				...
				oi(l, (n) => {
					var t = n.children;
					t?.length ? ((n.x = ji(t)), (n.y = Ui(t))) : ((n.x = o ? (c += e(n, o)) : 0), (n.y = 0), (o = n));
				});
				var f = Fi(l),
					s = Hi(l),
					h = f.x - e(f, s) / 2,
		...
		(ao.layout.treemap = () => {
			function n(n, t) {
				for (var e, r, i = -1, u = n.length; ++i < u; )
					(r = (e = n[i]).value * (0 > t ? 0 : t)), (e.area = Number.isNaN(r) || 0 >= r ? 0 : r);
			}
			function t(e) {
				var u = e.children;
				if (u?.length) {
	...
	ao.scale.linear = () => Wi([0, 1], [0, 1], Mr, !1);
	var kl = { s: 1, g: 1, p: 1, r: 1, e: 1 };
	ao.scale.log = () => ru(ao.scale.linear().domain([0, 1]), 10, !0, [1, 10]);
	var Nl = ao.format(".0e"),
		El = { floor: (n) => -Math.ceil(-n), ceil: (n) => -Math.floor(-n) };
	(ao.scale.pow = () => iu(ao.scale.linear(), 1, [0, 1])),
		(ao.scale.sqrt = () => ao.scale.pow().exponent(0.5)),
		(ao.scale.ordinal = () => ou([], { t: "range", a: [[]] })),
		(ao.scale.category10 = () => ao.scale.ordinal().range(Al)),
		(ao.scale.category20 = () => ao.scale.ordinal().range(Cl)),
		(ao.scale.category20b = () => ao.scale.ordinal().range(zl)),
		(ao.scale.category20c = () => ao.scale.ordinal().range(Ll));
	...
	(ao.scale.quantile = () => au([], [])),
		(ao.scale.quantize = () => lu(0, 1, [0, 1])),
		(ao.scale.threshold = () => cu([0.5], [0, 1])),
		(ao.scale.identity = () => fu([0, 1])),
		(ao.svg = {}),
		(ao.svg.arc = () => {
			function n() {
	...
	(Yl.call = Co.call),
		...
		(Yl.node = Co.node),
		(Yl.size = Co.size),
		(ao.transition = (n, t) => (n?.transition ? (Hl ? n.transition(t) : n) : ao.selection().transition(n))),
	...
	ao.svg.brush = () => {
		...
		function e(n) {
			n.selectAll(".resize").attr("transform", (n) => `translate(${s[+/e$/.test(n)]},${h[+/^s/.test(n)]})`);
		}
		function r(n) {
		...
		function _u() {
			...
			var M,
				...
				_z = W(this),
				L = ao.mouse(this),
				q = ao.select(t(this)).on("keydown.brush", u).on("keyup.brush", v);
			if (
				...
				var T = +/w$/.test(N),
					R = +/^n/.test(N);
				(_x = [s[1 - T] - L[0], h[1 - R] - L[1]]), (L[0] = s[T]), (L[1] = h[R]);
		...
		return (
			...
			(n.x = function (t) {
				return arguments.length ? ((c = t), (_v = Bl[(!c << 1) | !f]), n) : c;
			}),
			(n.y = function (t) {
				return arguments.length ? ((f = t), (_v = Bl[(!c << 1) | !f]), n) : f;
			}),
			(n.clamp = function (t) {
				return arguments.length
	...
	var Kl = [
		...
		tc = { range: (n, t, e) => ao.range(Math.ceil(n / e) * e, +t, e).map(io), floor: m, ceil: m };
	(Ql.year = ga.year), (ga.scale = () => ro(ao.scale.linear(), Ql, nc));
	var ec = Ql.map((n) => [n[0].utc, n[1]]),
		rc = Jl.multi([
	...
	(ec.year = ga.year.utc),
		(ga.scale.utc = () => ro(ao.scale.linear(), ec, rc)),
		(ao.text = An((n) => n.responseText)),
		(ao.json = (n, t) => Cn(n, "application/json", uo, t)),
		(ao.html = (n, t) => Cn(n, "text/html", oo, t)),
		(ao.xml = An((n) => n.responseXML)),
